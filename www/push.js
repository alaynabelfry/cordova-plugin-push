  ...
  _createClass(PushNotification, [
    {
      ...
      value: function unregister(successCallback) {
        ...
        exec(cleanHandlersAndPassThrough, errorCallback, "PushNotification", "unregister", [
          options,
        ]);
      },
      /**
...
module.exports = {
  ...
  showNotification: function showNotification(successCallback, errorCallback) {
    exec(successCallback, errorCallback, "PushNotification", "showNotification", []);
  },
